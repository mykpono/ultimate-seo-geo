...
| GEO / AI citations | `references/ai-search-geo.md`, `references/entity-optimization.md` | `robots_checker.py`, `ai_bot_access.py`, `ai_bot_logs.py`, `citation_sampling.py`, `entity_checker.py`, `preferred_sources_checker.py` | `03-geo-ai-search.md` |
